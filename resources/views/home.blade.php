...
<body>
            ...
            <div class="pr-5">
                <a href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        role="img" aria-labelledby="ai13u6ddlylgh4kxqk8213pz67i4pfl2" class="crayons-icon">
    ...
    <main class="mb-10 bg-gray-100 md:grid md:grid-cols-3 md:gap-4 lg:grid-cols-5 lg:gap-4">
            ...
            <aside class="">
                ...
                <div class="m-4 flex flex-wrap justify-start space-x-4">
                    <a href="https://twitter.com/thepracticaldev" target="_blank"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            role="img" aria-labelledby="akd1ghfeghf69vp04cd85hr2sq76k2pr"
                    ...
                    <a href="https://facebook.com/thepracticaldev" target="_blank"
                        class="c-link c-link--icon-alone c-link--block" rel="noopener me">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            role="img" aria-labelledby="a2r2e2vaky2if787v6d1p7i0gvxx56s9"
                            class="crayons-icon c-link__icon">
                    ...
                    <a href="https://github.com/forem" target="_blank"
                        class="c-link c-link--icon-alone c-link--block" rel="noopener me">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            role="img" aria-labelledby="a7724gmx409w0toxmwev2slttorlijku"
                            class="crayons-icon c-link__icon">
                    ...
                    <a href="https://instagram.com/thepracticaldev" target="_blank"
                        class="c-link c-link--icon-alone c-link--block" rel="noopener me">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            role="img" aria-labelledby="agji1egbyarcp6jupj0967qbgkkevkfj"
                            class="crayons-icon c-link__icon">
                    ...
                    <a href="https://twitch.com/thepracticaldev" target="_blank"
                        class="c-link c-link--icon-alone c-link--block" rel="noopener me">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            role="img" aria-labelledby="ahrqrxhlnhicr0bwok2tryasuxeqnmlz"
                            class="crayons-icon c-link__icon">
                    ...
                    <a href="https://fosstodon.org/@thepracticaldev" target="_blank"
                        class="c-link c-link--icon-alone c-link--block" rel="noopener me">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            role="img" aria-labelledby="afhzuek6gzpos1gduufwatmrfh539xqq"
                            class="crayons-icon c-link__icon">
        ...
        <div class="md:col-span-2 lg:col-span-3">
            <nav>
                <ul class="flex py-5">
                    <a href="{{route('products.relevant')}}"><li class="ml-5 font-bold" >Relevant</li></a>
            ...
            @foreach ($response as $item)
                ...
                <article class="mb-5 bg-slate-100 shadow-md">
                    <div>
                        <a href="#" title="17 Essential Tools to Boost Your Productivity 🚀🔥"
                            aria-label="article">
                    ...
                    <div class="mx-5 mt-5 flex items-center">
                        ...
                        <div class="flex flex-col">
                            ...
                            <a href="#">
                                <time datetime="2023-11-07T10:43:39Z"
                                    title="Tuesday, November 7, 2023 at 4:13:39 PM">
                                    {{$item->published_at}}
                                </time>
                            </a>
                        </div>
                    ...
                    <div class="my-5 flex flex-wrap">
                        @foreach ($item->tags as $tags)
                            <a class="ml-5" href="/t/python"><span
                                    class="crayons-tag__prefix">#</span>{{ $tags->title }}</a>
                        @endforeach
