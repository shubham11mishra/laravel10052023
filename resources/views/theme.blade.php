...
<header class="flex  h-12 w-full items-center justify-between bg-white py-2 shadow-md">
    <div class="flex items-center justify-start">
        <div class="pl-5">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img"
                 aria-labelledby="aqhafcdc661jjzhu34eqnxydievi9euu" class="crayons-icon">
    ...
    <div class="flex items-center justify-end">
        <div class="pr-5">
            <a href="#">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img"
                     aria-labelledby="ai13u6ddlylgh4kxqk8213pz67i4pfl2" class="crayons-icon">
        ...
        <aside class="">
            <div class="m-4 rounded-md bg-white p-4 shadow-md">
                ...
                <div class="flex flex-col">
                    <a href="/enter?state=new-user" class="mb-2 rounded-md bg-slate-900 p-2 text-center text-white"
                       aria-label="Create new account">Create account</a>
                    <a href="/enter" class="rounded-md bg-slate-900 p-2 text-center text-white"
            ...
            <div class="m-4 flex flex-wrap justify-start space-x-4">
                <a href="https://twitter.com/thepracticaldev" target="_blank"
                   class="c-link c-link--icon-alone c-link--block" rel="noopener me">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img"
                         aria-labelledby="akd1ghfeghf69vp04cd85hr2sq76k2pr" class="crayons-icon c-link__icon">
                ...
                <a href="https://facebook.com/thepracticaldev" target="_blank"
                   class="c-link c-link--icon-alone c-link--block" rel="noopener me">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img"
                         aria-labelledby="a2r2e2vaky2if787v6d1p7i0gvxx56s9" class="crayons-icon c-link__icon">
                ...
                <a href="https://github.com/forem" target="_blank" class="c-link c-link--icon-alone c-link--block"
                   rel="noopener me">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img"
                         aria-labelledby="a7724gmx409w0toxmwev2slttorlijku" class="crayons-icon c-link__icon">
                ...
                <a href="https://instagram.com/thepracticaldev" target="_blank"
                   class="c-link c-link--icon-alone c-link--block" rel="noopener me">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img"
                         aria-labelledby="agji1egbyarcp6jupj0967qbgkkevkfj" class="crayons-icon c-link__icon">
                ...
                <a href="https://twitch.com/thepracticaldev" target="_blank"
                   class="c-link c-link--icon-alone c-link--block" rel="noopener me">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img"
                         aria-labelledby="ahrqrxhlnhicr0bwok2tryasuxeqnmlz" class="crayons-icon c-link__icon">
                ...
                <a href="https://fosstodon.org/@thepracticaldev" target="_blank"
                   class="c-link c-link--icon-alone c-link--block" rel="noopener me">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img"
                         aria-labelledby="afhzuek6gzpos1gduufwatmrfh539xqq" class="crayons-icon c-link__icon">
    ...
    <div class="md:col-span-2 lg:col-span-3">
        ...
        <article class="mb-5 bg-slate-100 shadow-md">
            <div>
                <a href="#" title="17 Essential Tools to Boost Your Productivity 🚀🔥" aria-label="article">
                    <img class="rounded-t-md"
                         src="https://res.cloudinary.com/practicaldev/image/fetch/s--wP48g-um--/c_imagga_scale,f_auto,fl_progressive,h_420,q_auto,w_1000/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/zfzl1bmezdynbmhj5smy.png"/>
                </a>
            </div>
            ...
            <div class="mx-5 mt-5 flex items-center">
                <div class="mr-2">
                    <a href="#" class="">
                        <img class="max-h-10 rounded-full border border-gray-700"
                             src="https://res.cloudinary.com/practicaldev/image/fetch/s--4L_SFF-C--/c_fill,f_auto,fl_progressive,h_90,q_auto,w_90/https://dev-to-uploads.s3.amazonaws.com/uploads/user/profile_image/159737/10b8de99-9383-42da-80e2-851af40d5d0f.png"
                             alt="madza profile" loading="lazy"/>
                    </a>
                </div>
                <div class="flex flex-col">
                    <a href="#" class="text-16 font-semibold"> Madza </a>
                    <a href="#">
                        <time datetime="2023-11-07T10:43:39Z" title="Tuesday, November 7, 2023 at 4:13:39 PM">Nov
                            7
                        </time>
                    </a>
                </div>
            ...
            <div class="mx-5 flex items-center justify-between pb-5">
                <div class="flex items-center justify-between space-x-3">
                    ...
                    <span class="aggregate_reactions_counter">43<span
                            class="s:inline hidden">&nbsp;reactions</span></span>
                </div>

                <div>
                    <a href="/m4rri4nne/automating-your-api-tests-using-python-and-pytest-23cc#comments"
                       class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" role="img"
                             aria-labelledby="acv7kflv8liflqp4jqufw6zk6ng1taan" class="crayons-icon">
                ...
                <div class="flex items-center justify-center">
                    ...
                    <button type="button" id="article-save-button-1663252"
                            class="c-btn c-btn--icon-alone bookmark-button" data-reactable-id="1663252"
                            data-article-author-id="827329"
                            aria-label="Save post Automating your API tests using Python and Pytest to reading list"
                        ...
                        <span class="bm-success">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" aria-hidden="true">
                                    <path
                                        d="M6.75 4.5h10.5a.75.75 0 01.75.75v14.357a.375.375 0 01-.575.318L12 16.523l-5.426 3.401A.375.375 0 016 19.607V5.25a.75.75 0 01.75-.75z">
                                    </path>
                                </svg>
                            </span>
                    </button>
